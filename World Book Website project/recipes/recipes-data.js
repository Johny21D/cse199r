const countries = [
    ...
    { name: "Korea, North", code: "kp" }, { name: "Korea, South", code: "kr" }, { name: "Kuwait", code: "kw" },
    ...
    { name: "Pakistan", code: "pk" }, { name: "Palau", code: "pw" }, { name: "Panama", code: "pa" },
    ...
    { name: "South Africa", code: "za" }, { name: "South Sudan", code: "ss" }, { name: "Spain", code: "es" },
